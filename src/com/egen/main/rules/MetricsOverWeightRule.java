...
public class MetricsOverWeightRule extends BasicRule {
	...
	public MetricsOverWeightRule(double baseWT, boolean isPost) {

		super("OverWeightRule", "Check if person's weight is > 10% of base weight, if yes create an alert.", 1);
		BASE_WEIGHT = baseWT;
		this.isPost = isPost;
	}
	...
	public boolean evaluate() {
		return metrics.getValue() / BASE_WEIGHT > 1.1;
	}

	@Override
	public void execute() {
		StringBuilder objBuilder = new StringBuilder(
				"Weight has increased above 10% of base weight. Current weight is: ");
